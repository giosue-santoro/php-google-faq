...
<body>
    ...
    <header>
        <nav class="nav-top">
            <div class="left">
                <ul>
                    <li><img src="img/logo-google.jpg" alt="logo"></li>
    ...
    <main>
        ...
        // ***********************1***************************
        ["question" =>
            "Come state implementando la recente decisione della
            Corte di giustizia dell'Unione europea (CGUE) relativa al diritto
            all'oblio?",
            "answer" =>
        ...
        // ***********************4***************************
        ["question" =>
            "Come faccio a rimuovere informazioni su di me dai risultati di
            ricerca di Google?",
            "answer" =>
        ...
        // ***********************5***************************
        ["question" =>
            "Quando faccio clic sui risultati della Ricerca Google, le mie chiavi
            di ricerca vengono inviate ai siti web?",
            "answer" =>
        ...
        foreach($faq as $question) {
            ...
            if($key === "question"){
                echo "<h2>" . $value . "</h2> <br><br><br>";
            }else{
                echo "<p>" . $value . "</p> <br><br><br>";
            }
